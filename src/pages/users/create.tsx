import { Box, Button, Flex, HStack, Heading, Divider, VStack, SimpleGrid } from '@chakra-ui/react'
        ...
        <Box as='form' flex='1' borderRadius={8} bg='gray.800' p={['6','8']} onSubmit={handleSubmit(handleCreateUser)}>
          ...
          <VStack spacing='8'>
            ...
            <SimpleGrid minChildWidth='240px' spacing={['6','8']} w='100%'>
              ...
              <Input name='confirmation_password' type='password' label='Confirme sua Senha' {...register('password_confirmation')} error={errors.password_confirmation}/>
            </SimpleGrid>
          </VStack>
